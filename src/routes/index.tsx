...
const DESIGNS = [
  {
    ...
    points: [
      "Shark skin is covered with microscopic dermal denticles rather than a smooth surface.",
      "Engineered riblets mimic these longitudinal grooves and help keep cross-stream vortices away from the wall.",
      "The presentation reports about 5–8% skin-friction drag reduction for riblet surfaces.",
      "Applications include aircraft surfaces, high-performance vehicles, marine hulls and wind-turbine blades.",
    ],
  },
  {
    ...
    points: [
      "Dynamic soaring repeatedly crosses air masses of different speeds to extract energy from the ocean wind gradient.",
      "The albatross uses long, narrow wings for efficient gliding over long distances.",
      "Albatross-inspired hinged wingtips can react to gusts and reduce structural load on the main wing.",
      "Lower structural loads can support lighter aircraft structures and improved fuel efficiency.",
    ],
  },
  {
    ...
    points: [
      "The boxfish combines a compact body with a rigid, lightweight bony shell and relatively large internal volume.",
      "Its geometry influences flow separation, wake formation and pressure drag.",
      "The idea inspired vehicle forms using boxfish-like roof, side and rear contours.",
      "The Mercedes-Benz Bionic concept is presented with a reported drag coefficient of 0.19; the PPT also notes that later research questioned universal passive-stability claims.",
    ],
  },
];

const TEAM = [
  { name: "Dhruv", roll: "C302", image: "/assets-b64/dhruv.jpg.b64" },
  { name: "Arya", roll: "C322", image: "/assets-b64/arya.jpg.b64" },
  { name: "Tanaya", roll: "C324", image: "/assets-b64/tanaya.jpg.b64" },
  { name: "Daksh", roll: "C327", image: "/assets-b64/daksh.jpg.b64" },
];

const CITATIONS = [
  {
    label: "Riblets for aircraft – skin friction reduction – Michael J. Walsh",
    url: "",
  },
  {
    label: "YouTube – Shark-skin / riblet reference video",
    url: "https://www.youtube.com/watch?v=c_zvlwGqZpM",
  },
  {
    label: "Airbus – AlbatrossOne",
    url: "https://www.airbus.com/en/innovation/future-aircraft/wings/albatrossone",
  },
  {
    label: "Airbus – Biomimicry: engineering in nature’s style",
    url: "https://www.airbus.com/en/newsroom/news/2018-01-biomimicry-engineering-in-natures-style",
  },
  {
    label: "YouTube – Albatross-inspired concept reference",
    url: "https://www.youtube.com/watch?v=d1z8YUs2FLc",
  },
  {
    label: "Slate – Mercedes-Benz bionic car / boxfish stability and agility",
    url: "https://slate.com/technology/2015/03/mercedes-benz-bionic-car-boxfish-stability-and-agility-paradox-finally-solved.html",
  },
  {
    label: "YouTube – Boxfish biomimicry reference",
    url: "https://www.youtube.com/watch?v=xOQrVQfqE08",
  },
];
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-border bg-secondary/20 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Biomimicry means learning from nature and translating those strategies into human
              design. The presentation describes evolution as billions of years of natural
              optimisation for efficient performance with minimal energy input.
            </p>
          </div>
          <div className="rounded-2xl border border-border bg-secondary/20 p-4">
            <div className="tech-label text-[10px] text-primary">Why it helps aerodynamics</div>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Nature offers textured surfaces, flexible structures and passive vortex control
              that can reduce energy losses without relying on extra active actuators.
            </p>
          </div>
          <div className="rounded-2xl border border-border bg-secondary/20 p-4">
            <div className="tech-label text-[10px] text-primary">Engineering impact</div>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              The PPT connects these ideas with lower drag, reduced energy consumption, improved
              vehicle stability and lighter, more efficient transportation systems.
            </p>
          </div>
        </div>
      </Panel>
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              View the complete presentation directly on the website.
            </p>
          </div>
          <button
            onClick={downloadPpt}
      ...
      <Panel className="overflow-hidden p-2 sm:p-3">
        {loading ? (
          <div className="flex min-h-[65vh] items-center justify-center text-sm text-muted-foreground">
          ...
          <div className="flex min-h-[50vh] items-center justify-center p-8 text-center text-sm text-muted-foreground">
            Presentation preview could not be loaded.
          </div>
        )}
      </Panel>
    </div>
    ...
    <div className="space-y-5">
      <Panel className="p-5 sm:p-7">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Team members and roll numbers from the first slide of the presentation.
        </p>
      </Panel>
      ...
      <header className="glass sticky top-3 z-50 mb-6 rounded-2xl border border-border/70 px-4 py-3 backdrop-blur-xl sm:px-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <button onClick={() => setSection("Overview")} className="text-left">
            <div className="tech-label text-[9px] text-accent sm:text-[10px]">
              Biomimicry • Aerodynamics
            </div>
            <div className="font-display text-sm font-extrabold sm:text-base">
              Nature-Inspired Transport Design
            </div>
          </button>
